...
public class Slots {
    ...
    public Slots(int credits, int boughtCredits, int bet, double payout, double creditBuyout, int reel1, int reel2, int reel3) {
        this.credits=credits;
        this.boughtCredits=boughtCredits;
        this.bet=bet;
        this.payout=payout;
        this.askedCredits =creditBuyout;
        this.reel1=reel1;
        this.reel2=reel2;
        this.reel3=reel3;
        createForm();
    ...
    //if you have funds the credits are added
    ...
    public void generateNumbers() {
        ...
        if (cbAlwaysWin.isSelected() == true) { // Always win cheat mode
            int winType = rand.nextInt(4); //determines the type of win
            reel1 = rand.nextInt(images.size());
            if (winType == 0) { //0 - Reels 1, 2 and 3 will all match
                reel2 = reel1;
                reel3 = reel1;
            } else if (winType == 1) { //1 - Reels 1 and 2 will match
                reel2 = reel1;
            } else if (winType == 2) { //2 - Reels 1 and 3 will match
                reel3 = reel1;
            } else {    //3 - Reels 2 and 3 will match
                if (reel1 >= 0 ) {
                    reel2 = reel1 + 1;
                    reel3 = reel1 + 1;
        ...
        } else { //win cheat mode is disabled => normal game
            reel1 = rand.nextInt(images.size());
